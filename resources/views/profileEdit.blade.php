        ...
        <div class="d-flex justify-content-center">
          <div class="singleJobHeroContent">
            <div class="text-center">
              <h3 class="cl-white">Edit Profile</h3>
            </div>
            <div class="breadcrumb">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item cl-white">Edit Profile</li>
                </ol>
              </nav>
            </div>
          </div>
    ...
    <section class="profileEdit p-100">
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-7">
            <form action="edit-data" method="POST" enctype="multipart/form-data">
              @csrf
                ...
                <div class="row">
                          ...
                          <div class="col-lg-6 mb-4">
                            <div class="">
                                ...
                                <input type="text" name="name" class="form-control w-100 bg-cl-ash2"
                                value="{{ Auth::user()->name }}">
                              </div>
                        </div>
                        <div class="col-lg-6 mb-4">
                            <div class="">
                                <label class="mb-2">Email (Cannot be changed)</label>
                                <input type="email" name="email" class="form-control w-100 bg-cl-ash2"
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="">
                                ...
                                <input type="number" name="phone" class="form-control w-100 bg-cl-ash2"
                        ...
                        <div class="col-lg-6 mb-4">
                            <div>
                              ...
                              <select name="country"
                                class="form-select mb-3 rounded-3  bg-cl-ash2"
