              ...
              <div>
                ...
                <form method="POST" action="{{ route('register') }}">
                  ...
                  <div class="signInFeildBox">
                    <input type="text"
                    class="w-100 mb-3 py-2 px-3 rounded-3 border-0 bg-cl-ash2 @error('name') is-invalid @enderror"
                  ...
                  <div class="signInFeildBox">
                    ...
                    class="w-100 mb-3 py-2 px-3 rounded-3 border-0 bg-cl-ash2 @error('email') is-invalid @enderror" 
                  ...
                  <div class="signInFeildBox">
                    ...
                    class="w-100 mb-3 py-2 px-3 rounded-3 border-0 bg-cl-ash2 @error('password') is-invalid @enderror" 
                  ...
                  <div class="signInFeildBox">
                    ...
                    type="password" class="w-100 mb-3 py-2 px-3 rounded-3 border-0 bg-cl-ash2" 
