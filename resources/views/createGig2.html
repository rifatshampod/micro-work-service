        ...
        <div class="row">
          ...
          <div class="col-xxl-3 col-xl-4">
            <div class="singleJobMidRight p-4">
                ...
                <div>
                    <div>
                        <h4 class="cl-mat-black">Categories</h4>
                    </div>
                    <div>
                        <small class="cl-grey">Web Design</small>
                    </div>
                    <div class="mb-3">
                        <small class="cl-grey">Web Development</small>
                    </div>
                    <div>
                        <h4 class="cl-mat-black">Total Gigs <span class="ms-3 cl-pm">20</span></h4>
                    </div>
                </div>
            </div>
          </div>
