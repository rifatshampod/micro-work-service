...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('gig') }}'><i class='nav-icon la la-user-tag'></i> Gigs</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('contest') }}'><i class='nav-icon la la-trophy'></i> Contests</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('campaign') }}'><i class='nav-icon la la-calendar-check'></i> Campaigns</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('category') }}'><i class='nav-icon la la-th-list'></i> Categories</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('career') }}'><i class='nav-icon la la-user-lock'></i> Careers</a></li>
