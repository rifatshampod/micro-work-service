      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-4">
            <div class="singleJobMidRight">
                <div class="singleJobRightTop d-flex align-items-center px-4 py-3 mb-3">
                  <div class="singleJobRightTopIcon d-flex justify-content-center align-items-center me-3">
                    <i class="fas fa-check cl-white fs20"></i>
                  </div>
                  <div class="cl-white">
                    <div>
                      <small class="fs20 fw-bold">Excelent</small>
                    </div>
                    <div>
                      <small class="fw-lighter">The Job Done Successfully</small>
                    </div>
                  </div>
                </div>
                <div class="singleJobRightTop2nd d-flex align-items-center mx-4 bg-cl-ash2 mb-3">
                  <div class="singleJobRightTop2ndImg me-2">
                    <img src="assets/image/About/team1.png" alt="">
                  </div>
                  <div>
                    <div>
                      <small class="fs16 cl-pm fw-bold">Rifat Bin Shampad</small>
                    </div>
                    <div>
                ...
                <div class="mb-3 mx-4">
                  <small class="fs14">Buyer Gave you the following review with his opinion</small>
                </div>
                <div class="bg-cl-ash p-3 mx-4 rounded-3 mb-2">
                  <small class="fs14"
                    >That was a great job. Hope we will work together in future.</small
                  >
                </div>
                <div class="mx-4 d-flex justify-content-center mb-5">
                  <i class="fas fa-star fs14 me-1 cl-yellow"></i>
                  <i class="fas fa-star fs14 me-1 cl-yellow"></i>
                  <i class="fas fa-star fs14 me-1 cl-yellow"></i>
                  <i class="fas fa-star fs14 me-1 cl-yellow"></i>
                  <i class="fas fa-star fs14 me-1 cl-yellow"></i>
