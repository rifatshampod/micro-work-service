            ...
            <div class="singleJobMidRight">
                <div class="singleJobRightTop d-flex align-items-center px-4 py-3 mb-3">
                  <div class="singleJobRightTopIcon d-flex justify-content-center align-items-center me-3">
                    <i class="fas fa-trophy cl-white fs20"></i>
                  </div>
                  <div class="cl-white">
                    <div>
                      <small class="fs20 fw-bold">Winner of <br> the Contest</small>
                    </div>
                  </div>
                </div>
                <div class="singleJobRightTop2nd d-flex align-items-center mx-4 p-2 bg-cl-ash2 mb-3">
                  ...
                  <div>
                    ...
                    <div>
                        <small>Total Wins: <span class="cl-pm fw-bold">10</span></small>
                      </div>
                  </div>
                </div>
                <div class="mx-4 mb-3">
